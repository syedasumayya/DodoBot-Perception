"""
DoDo Bot — Day 1: Obstacle Detection Bootstrap
...
# "Known Issues" section in docs/Day1_Report.pdf for why, and what to redo
...
#   (Full per-class table in docs/Day1_Report.pdf and results/training_log.txt)
...
# Save best.pt into Day1_ObstacleDetection/weights/ in this repo after downloading.
